let showModal_Onclick = function (e) {
  ...
  document
    .querySelector("#SliderIDHeight")
    .classList.remove("SliderIDBackground");
};
...
let hideModal_Onclick = function () {
  ...
  document
    .querySelector("#SliderIDHeight")
    .classList.remove("top-slider-arrow");
...
//first tab
let CreateTreeMap = function (entries) {
  let setMap = {
    view: {
      lat: 32.306,
      lon: 51.24,
  ...
  let setTree = null;
  new CreateTree("treeid", setTree, map, entries);
};
...
let TreeMapMode_Onclick = function (elem) {
  $("#views")
    .children("img")
    .attr("src", window.imagesource.maptreeviewselected);
  $("#views").css("background-color", "#00a693");
  //$("#views img")[0].src = $(elem).children()[0].src
...
let collection_childs = function () {
  ...
  collectionData.forEach(function (dt, i) {
    ...
    _child.innerHTML =
      ...
      dt.title +
      "</div></div>" +
      '<div class="row"><div> موقعیت: </div><div>' +
      dt.position +
      "</div></div>" +
      "</div>" +
      "</div>" +
      ...
      (i % 2 == 0 ? "padding-pic-list" : " pr-0") +
      '">' +
      '<div class="container-fluid">' +
      '<div class="row mb-3"><div>' +
      dt.title +
      "</div></div>" +
      '<div class="row"><div class="versin-detail-data-text-subject"> تاسیس: </div><div>' +
      dt.established +
      "</div></div>" +
...
let collection_childs_slider = function (collectionData) {
  let _div = document.querySelector(
      "#collection_childs_slider .swiper-wrapper"
    ),
    itemChild = "";
  for (let i = 0; i < collectionData.length; i++) {
    if (i % 12 == 0) {
      ...
      $(itemChild).addClass(
        "item-list d-flex flex-column justify-content-start p-3"
      ); /* Updated 06 */
...
let collection_ListViewMode_Onclick = function (elem) {
  ...
  document
    .querySelectorAll(".versin-detail-data-img")
    .forEach(function (el, i) {
...
let collection_TwoViewMode_Onclick = function (elem) {
  $("#views")
    .children("img")
    .attr("src", window.imagesource.tworowviewselected);
  $("#views").css("background-color", "#00a693");
  //$("#views img")[0].src = $(elem).children()[0].src
  document.querySelector("#collection_childs_show").classList.add("d-none");
  document
    .querySelector("#collection_childs_parent")
    .classList.remove("d-none");
  if (document.querySelector("#collection_childs").children.length == 0)
    collection_childs();
  document
    .querySelectorAll(".versin-detail-data-parent")
    .forEach(function (el, i) {
  ...
  document
    .querySelectorAll(".versin-detail-data-text")
    .forEach(function (el, i) {
      el.classList.remove("d-none");
      el.classList.add("col-md-6");
...
let version_childs = function () {
  ...
  versionData.forEach(function (dt, i) {
    ...
    _child.innerHTML =
      ...
      '<div class="col-md-6 versin-detail-data-img mb-2"><div class="container" style="padding:unset;"><img style="height:230px;width:100%;" class="img" src="' +
      dt.src +
      '" onclick="CreateGallery(this)"/>' +
      '<div class="versin-detail-data-img-title mr-3">' +
      '<div class="container-fluid">' +
      '<div class="row"><div> نسخه شماره </div><div>' +
      dt.id +
      "</div></div>" +
      '<div class="row"><div> محل نگهداری: </div><div>' +
      dt.place +
      "</div></div>" +
      "</div>" +
      "</div>" +
      ...
      '<div class="col-md-6 versin-detail-data-text">' +
      '<div class="container-fluid">' +
      '<div class="row mb-3"><div> نسخه شماره </div><div>' +
      dt.id +
      "</div></div>" +
      ...
      dt.date +
      "</div></div>" +
      '<div class="row"><div class="versin-detail-data-text-subject"> رنگ: </div><div>' +
      dt.color +
      "</div></div>" +
      '<div class="row"><div class="versin-detail-data-text-subject"> جنس: </div><div>' +
      dt.material +
      "</div></div>" +
      '<div class="row"><div class="versin-detail-data-text-subject"> تکنیک: </div><div>' +
      dt.technique +
      "</div></div>" +
      '<div class="row"><div class="versin-detail-data-text-subject"> ابعاد: </div><div>' +
      dt.dimension +
      "</div></div>" +
      '<div class="row"><div class="versin-detail-data-text-subject"> واقف: </div><div>' +
      dt.benefactor +
      "</div></div>" +
      "</div>" +
      "</div>" +
  ...
  document
    .getElementById("pills-prescription")
    .classList.remove("show", "active");
  document
    .getElementById("pills-Collection")
    .classList.remove("show", "active");
};
...
let Version_ListViewMode_Onclick = function (elem) {
  ...
  if (swiper.querySelector(".swiper-wrapper").children.length == 0)
    version_childs_slider();
...
let Version_GalleryViewMode_Onclick = function (elem) {
  $("#views")
    .children("img")
    .attr("src", window.imagesource.galleryviewselected);
  //$("#views img")[0].src = $(elem).children()[0].src
  $("#views").css("background-color", "#00a693");
...
let Version_OneViewMode_Onclick = function (elem) {
  $("#views")
    .children("img")
    .attr("src", window.imagesource.onerowviewselected);
  $("#views").css("background-color", "#00a693");
  //$("#views img")[0].src = $(elem).children()[0].src
  document.querySelector("#version_childs_show").classList.add("d-none");
  document.querySelector("#version_childs_parent").classList.remove("d-none");
...
let CreateGallery = function (elem) {
  ...
  datagallery = [
    {
      ...
      teqnique:
        "دست ساز ترمه آهار مهره ومقواااادست ساز ترمه آهار مهره ومقواااادست ساز ترمه آهار مهره ومقواااا",
      demensions: "طول 35 و عرض 15 سانتیمتر و",
      waqf: "حاج حسین آقا ملک",
      tabpage: "برگگه 45 پشت از برگه 245",
      soreinfo: "الفتح 45-11",
      verseaye:
        "قَالَ يَا قَوْمِ لِمَ تَسْتَعْجِلُونَ بِالسَّيِّئَةِ قَبْلَ الْحَسَنَةِ لَوْلَا تَسْتَغْفِرُونَ اللَّهَ لَعَلَّكُمْ تُرْحَمُونَ ووَلَقَدْ أَرْسَلْنَا إِلَى ثَمُودَ أَخَاهُمْ صَالِحًا أَنِ اعْبُدُوا اللَّهَ فَإِذَا هُمْ فَرِيقَانِ يَخْتَصِمُونَ",
    },
    {
      id: "2",
  ...
  document
    .querySelector("#SliderIDHeight")
    .classList.add("SliderIDHeight-thumb");
  ...
  for (let i = 0; i < datagallery.length; i++) {
    let slide =
      ...
      datagallery[i].src +
      ');background-position: center;background-size: 100% 100%;background-repeat: no-repeat;" iid="' +
      datagallery[i].id +
      '"></div>';
...
let remove_class = function (val) {
  ...
  document
    .querySelector("#SliderIDHeight")
    .classList.remove("multi-slider-view");
  document
    .querySelector("#SliderIDHeight")
    .classList.remove("thumb-slider-view");
...
let fullpage = function () {
  ...
  document
    .querySelector("#SliderIDHeight")
    .classList.remove("SliderIDHeight-thumb");
...
let fullpageWithThumb = function (e) {
  if (!e.getAttribute("view")) {
    ...
    document
      .querySelectorAll(".btn-shape-Swiper-bottom")
      .forEach(function (el, i) {
        el.classList.remove("d-none");
      });
  } else {
  ...
  for (let i = 0; i < datagallery.length; i++) {
    let slide1 =
      ...
      '"></div>';
    let slide2 =
      '<div class="swiper-slide" onclick="thumbnailSlide_onClick(this)" style="background-image:url(' +
      datagallery[i].src +
      ');background-position: center;background-size: 100% 100%;background-repeat: no-repeat;" iid="' +
      datagallery[i].id +
      '"></div>';
